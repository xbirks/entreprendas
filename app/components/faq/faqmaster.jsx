...
function FaqMaster() {
    ...
    const faqSchema = {
        ...
        "mainEntity": [
            {
                "@type": "Question",
                "name": "¿Cuánto cuesta ajustar el largo de un vestido?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "El precio rondará los 12€ aunque depende del tipo de tela y la complejidad del arreglo. Nos aseguramos de que el acabado sea impecable y adaptado a tus necesidades para que el vestido luzca perfecto."
                }
            },
            {
                "@type": "Question",
                "name": "¿Qué hago si mi pantalón me queda grande de cintura?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Podemos entallar la cintura de tus pantalones para que se ajusten mejor a tu cuerpo sin perder comodidad. Necesitaremos que vengas a nuestro taller para que te pruebes el pantalón y lo podamos ajustar."
                }
            },
            {
                "@type": "Question",
                "name": "¿Se pueden cambiar las cremalleras de chaquetas y pantalones?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Sí, realizamos el cambio de cremalleras en chaquetas, pantalones y cualquier otra prenda. Utilizamos cremalleras de alta calidad para que el resultado sea duradero y funcional."
                }
            },
            {
                "@type": "Question",
                "name": "¿Cuánto tardan en hacer un arreglo de ropa?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "El tiempo de entrega depende del tipo de arreglo y la carga de trabajo en el momento. Normalmente, los ajustes básicos pueden estar listos en 2 días, mientras que arreglos más complejos pueden requerir hasta 5 días."
                }
            },
            {
                "@type": "Question",
                "name": "¿Es posible convertir un vestido largo en uno corto?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Sí, podemos transformar un vestido largo en uno corto manteniendo la armonía del diseño. Consulta nuestros precios en la sección de listado de precios."
                }
            },
            {
                "@type": "Question",
                "name": "¿Cómo puedo saber si un arreglo es posible en mi prenda?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Si tienes dudas sobre si tu prenda se puede modificar, tráela y la evaluaremos sin compromiso. Analizamos la tela, costuras y diseño para ofrecerte la mejor solución posible. Y te daremos un presupuesto al instante."
                }
            },
            {
                "@type": "Question",
                "name": "¿Qué tipo de arreglos se pueden hacer en trajes de hombre?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Realizamos ajustes en trajes de hombre como entallar chaquetas, ajustar pantalones, modificar mangas y adaptar el fit general para que la prenda se ajuste perfectamente a tu cuerpo."
                }
            },
            {
                "@type": "Question",
                "name": "¿Pueden hacer arreglos en vestidos de novia?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Sí, ajustamos vestidos de novia para que te queden perfectos en tu gran día. Te recomendamos traerlo con un mes de antelación para poder ajustarlo a la perfección."
                }
            },
            {
                "@type": "Question",
                "name": "¿Cuáles son los arreglos más comunes en ropa?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Los arreglos más solicitados incluyen ajustes de cintura, bajos de pantalón, cambio de cremalleras, modificación de mangas y transformación de prendas para darles un nuevo estilo."
                }
            },
            {
                "@type": "Question",
                "name": "¿Se pueden personalizar complementos como velos y guantes?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Sí, podemos añadir detalles personalizados a complementos como velos, guantes y cinturones. Desde encajes hasta pedrería. Necesitaremos que traigas los elementos que quieras añadir a tus complementos."
                }
            },
            {
                "@type": "Question",
                "name": "¿Puedo arreglar una prenda de segunda mano para que me quede bien?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Sí, adaptamos ropa de segunda mano para que tenga un ajuste perfecto y luzca como nueva. Entallamos, acortamos y hacemos cualquier modificación necesaria para que se adapte a tu cuerpo."
                }
            },
            {
                "@type": "Question",
                "name": "¿Cómo puedo conseguir un presupuesto para un arreglo?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Puedes ponerte en contacto con nosotros o visitarnos para evaluar tu prenda. Te daremos un presupuesto sin compromiso y te explicaremos el proceso del arreglo."
                }
            },
            {
                "@type": "Question",
                "name": "¿Cómo puedo ajustar un traje fallero para que me quede perfecto?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Si tu traje fallero no te queda del todo bien, podemos ajustarlo para que se adapte perfectamente a ti. Ya sea que necesites entallar la chaqueta, modificar la falda o mejorar los detalles del corpiño, nos encargamos de que todo quede impecable sin perder la esencia tradicional del traje."
                }
            },
            {
                "@type": "Question",
                "name": "¿Es posible modificar una prenda para hacerla más cómoda para la lactancia?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Por supuesto, podemos añadir aperturas discretas, cierres fáciles de usar y cualquier ajuste que haga que amamantar sea más práctico sin renunciar al estilo."
                }
            },
            {
                "@type": "Question",
                "name": "¿Se pueden hacer arreglos en ropa para mascotas?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Sí, también nos ocupamos de la ropa de los más peludos de la casa. Si tu mascota necesita un abrigo más ajustado, una prenda reparada o incluso un diseño personalizado, podemos hacer que le quede perfecto."
                }
            }
        ]
    };

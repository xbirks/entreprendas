...
export const metadata = {
  ...
  alternates: {
    canonical: "https://www.entreprendas.es/municipios/benetusser",
    languages: {
      "es-ES": "https://www.entreprendas.es/municipios/benetusser",
    },
  },
};

export default function BenetusserLayout({ children }) {
  const localBusinessSchema = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    "name": "Entre Prendas - Arreglo de ropa en Benetússer",
    "description": "Servicio profesional de arreglo de ropa en Benetússer con 10 años de experiencia. Ajustes, composturas y arreglos de todo tipo de prendas.",
    "url": "https://www.entreprendas.es/municipios/benetusser",
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "position": 2,
        "name": "Benetússer",
        "item": "https://www.entreprendas.es/municipios/benetusser"
      }
    ]
  };

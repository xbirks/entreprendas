  ...
  return (
    <div className="gartalia">
      ...
      <p className="p_pol">Usted tiene derecho a:<br></br><br></br>
        ...
        - Rectificar datos inexactos o incompletos.<br></br>
        - Suprimir sus datos cuando ya no sean necesarios para los fines recogidos.<br></br>
        - Oponerse al tratamiento de sus datos personales.<br></br>
        - Limitar el tratamiento de sus datos en determinadas circunstancias.<br></br>
        - Retirar su consentimiento en cualquier momento.<br></br><br></br>
